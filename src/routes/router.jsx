...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "about", lazy: lazyComponent(() => import("../pages/AboutPage")) },
      { path: "skills", lazy: lazyComponent(() => import("../pages/SkillsPage")) },
      ...
      { path: "contact", lazy: lazyComponent(() => import("../pages/ContactPage")) },
